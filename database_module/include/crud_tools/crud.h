...
enum crud_operation_status find_by_field(struct operator op1, struct operator op2, enum find_operation operation, struct result_list_tuple **result, struct result_list_tuple **new_result);
